...
export function BasicForm() {
  ...
  return (
    // Step:1 Adding className for making flex
    // Step:2 Refer styling App.css => add-movie-form
    <form className="add-movie-form" onSubmit={formik.handleSubmit}>
      ...
      value={formik.values.email} 
        ...
        // Step:3 Added onBlur={formik.handleBlur}
        onBlur={formik.handleBlur}
      />
      {/* {formik.errors.email} */}
      {/* Step:6 conditional rendering applied => error message only display, once you touched the input field and having error */}
      ...
      <input 
        ...
        onChange={formik.handleChange} 
        name="password"
        // Step:4 Added onBlur={formik.handleBlur}
        onBlur={formik.handleBlur}
      />
      {/* {formik.errors.password} */}
      {/* Step:7 conditional rendering applied => error message only display, once you touched the input field and having error */}
...
// Form Validation before error message handling
